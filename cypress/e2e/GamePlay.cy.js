describe('GamePlay component', () => {
  beforeEach(() =>{
    ...
    cy.intercept('GET', 'https://fathomless-river-45488-66abd37a0e2d.herokuapp.com/favorites', {
      statusCode: 200,
      body: []
    })
    cy.intercept('GET', 'https://fathomless-river-45488-66abd37a0e2d.herokuapp.com/game', {
      statusCode: 200,
      fixtures: 'game-play'
    })
    cy.visit('http://localhost:3000/game')
  ...
  it('displays the game play page', () => {
    // cy.intercept('GET', 'https://fathomless-river-45488-66abd37a0e2d.herokuapp.com/game', {
    //   statusCode: 200,
    //   fixtures: 'game-play'
    // })
    ...
    cy.get('[data-cy="scientific-name-li"]').contains('Oryctolagus cuniculus');
  ...
  // it('displays initial animal image and facts', () => {
  //   cy.get('[data-cy="animal-container"]').within(() => {
  //     cy.get('[data-cy="animal-name"]').contains('rabbit')
  //     cy.get('[data-cy="animal-pic"]').should('have.attr', 'src')
  //     cy.get('[data-cy="facts-list"]').each(() => {
